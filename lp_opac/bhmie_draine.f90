SUBROUTINE BHMIE(X,REFREL,NANG,S1,S2,QEXT,QABS,QSCA,QBACK,GSCA)
  IMPLICIT NONE
  ...
  PARAMETER(MXNANG=1000,NMXX=200000)
  ...
  REAL, INTENT(OUT) :: GSCA,QBACK,QEXT,QSCA,QABS
